...
describe("JSON code Cycle", function () {
...
describe("JSON decode Cycle", function () {
    ...
    it("it should decode cycles when are present", function () {
        ...
        var myArrayDecoded = JSONCycle.decodeCycles([1, 'a', { '$ref': '$' }]);
    ...
    it("it should decode cycles when are present (2 reference repetitions)", function () {
        ...
        var myArrayDecoded = JSONCycle.decodeCycles([1, 'a', { '$ref': '$' }, { '$ref': '$' }]);
        expect(myArrayDecoded).toEqual(myArray);
    });
